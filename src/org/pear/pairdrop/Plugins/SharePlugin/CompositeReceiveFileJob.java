...
import org.pear.pairdrop.Helpers.MediaStoreHelper;
...
public class CompositeReceiveFileJob extends BackgroundJob<Device, Void> {
    ...
    private void openFile(DocumentFile fileDocument) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Uri contentUri = FileProvider.getUriForFile(getDevice().getContext(), "org.pear.pairdrop_tp.fileprovider", file);
