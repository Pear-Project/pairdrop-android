...
package org.pear.pairdrop.Plugins.RemoteKeyboardPlugin;
...
//        Log.d("RemoteKeyboardPlugin", "Committing visible key '" + key + "'");
    ...
    public boolean checkRequiredPermissions() {
        return Settings.Secure.getString(context.getContentResolver(), Settings.Secure.ENABLED_INPUT_METHODS).contains("org.pear.pairdrop_tp");
    }
